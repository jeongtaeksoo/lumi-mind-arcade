...
루미와 함께 5라운드 동안 집중력·기억력·패턴 인식·방향 순서 입력을 훈련하는 3분 브라우저 아케이드 게임입니다.

## 플레이 구조

- 5개의 하트로 시작합니다.
- 한 라운드는 4개 모드 중 무작위로 선택된 미니게임 3개를 모두 완료해야 클리어됩니다.
- 집중·기억·패턴·방향 모드의 순서는 라운드마다 섞이며, 현재 순서는 하단 스테이지 트래커에 표시됩니다.
